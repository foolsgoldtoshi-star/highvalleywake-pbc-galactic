<!-- 🌱 Generated from docs/NIX-INTEGRATION-BLUEPRINT.md -->
<script>
  export let sitemap = [];
  export let pageData = {};
</script>
...
<div class="wiki-page">
  <div class="page-header">
    <h1 class="page-title">🌌 Nix Integration Blueprint for Galactic Infrastructure</h1>
    <div class="wiki-badge">📚 Wiki Documentation</div>
  </div>

  <div class="content-wrapper">
    <div class="markdown-content">
      {@html `# 🌌 Nix Integration Blueprint for Galactic Infrastructure
